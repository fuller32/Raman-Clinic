...
dlgtitle = 'Input';
dims = [1 35];
definput = {'','mm-dd-yyyy HH:MM:SS','mm-dd-yyyy HH:MM:SS','0','0','10000'};
...
dlgtitle = 'Input';
dims = [1 35];
definput = {'.2','1','.01','0.01','1','0.01','1','5','.01'};
...
R = [alpha;T];
if range == 0
    writematrix(R,name + '_full_range.csv')
else
    writematrix(R,name + '_'+ num2str(range)+ 's.csv')
end
...
if 1 == strcmp(comp,'mexw64')
    save(name + '_' + num2str(range) + 's_fitparameters','fitparams','-v7.3');
else
