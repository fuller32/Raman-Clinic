...
%}
    ...
    DA2.name = "DA-2";
    DA2.order = ["read_Ondax_files",...
                    "Methacrylate_Raman_Cure",...
                    "LA_Raman_Cure",...
                    "LA_Me_Comp",...
                    "generate_Report"];

    %% Epoxy_Raman_Cure
    DA2.Methacrylate_Raman_Cure.settings = {'','','','0','0','1000','.2','1',...
        '.01','0','1','0.01','1','5','.01'}; 
    DA2.Methacrylate_Raman_Cure.prompt = {'Mat-File','Start Time','Stop Time',...
        'Time Lower Limit','Time Upper Limit','Lambda','Alpha Min Value',...
        'Alpha Max Value','Alpha Step Size','k Min Value','k Max Value',...
        'k Step Size','n Min Value','n Max Value','n Step Size'};
    %% LA_Raman_Cure
    DA2.LA_Raman_Cure.settings = {'','','','0','0','0','.1','1',...
        '.01','0','1','0.01','1','10','.1'}; 
    DA2.LA_Raman_Cure.prompt = {'Mat-File','Start Time','Stop Time',...
        'Time Lower Limit','Time Upper Limit','Baseline Fit Order','Alpha Min Value',...
        'Alpha Max Value','Alpha Step Size','k Min Value','k Max Value',...
        'k Step Size','n Min Value','n Max Value','n Step Size'};
